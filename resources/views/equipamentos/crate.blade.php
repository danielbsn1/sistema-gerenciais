...
<div class="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-8">
    ...
    <form method="POST" action="{{ route('equipamentos.store') }}" class="space-y-5">
        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <div>
                <label class="text-xs text-gray-500 block mb-1">Valor de Aquisição</label>
        ...
        <div class="flex gap-3 pt-2">
            ...
            <a href="{{ route('equipamentos.index') }}" class="text-gray-400 text-sm py-2 hover:text-gray-600">
                Cancelar
            </a>
        </div>
    </form>
